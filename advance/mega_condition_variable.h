...
/* 系统时间往前改动，直接导致std::mutex::wait_for超时失效。
 * linux+gcc:
 *    gcc版本和glibc版本对wait_for都有影响，gcc >=10 且 glibc >= 2.30 才会对程序行为没有影响。
 * bug论证：https://gcc.gnu.org/bugzilla/show_bug.cgi?id=41861
 *  修改方法：
 *  now steady clock can be used. also refer to:
 *  https://github.com/gcc-mirror/gcc/commit/2f5934326542b3f303db91cc4cd432cd488f0258
 *  but pthread_cond_clock wait is not supported by glibc below version 2.3. so I delete relative code.
 *  also refer to:
 *  https://gcc.gnu.org/git/?p=gcc.git&a=commit;h=ad4d1d21ad5c515ba90355d13b14cbb74262edd2
 * */
